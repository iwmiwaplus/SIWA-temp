...
#     e_nc,i_nc,t_nc=hl.split_ETI(et_nc=BASIN['data_cube']['monthly']['eta'],
...
#     print("ET splited successfully")

    #Calulate yearly data to fill in Sheet 2    
    ET=cf.calc_flux_per_LU_class(BASIN['data_cube']['monthly']['eta'], 
    ...
    print("NC files read successfully")
